...
public class DialogUtil {
    ...
    public View showTopDialog(@LayoutRes int resource) {
        ...
        topDialog.setContentView(viewTop, new ViewGroup.LayoutParams(LinearLayoutCompat.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    //设置弹窗的外边距和内边框
    public View showTopDialog(@LayoutRes int resource, int margin, int padding) {
...
//         把参数设置到Dialog里
    ...
    public View showMiddleDialog(@LayoutRes int resource, int margin, int padding) {
...
//         把参数设置到Dialog里
    ...
    public View showBottomDialog(@LayoutRes int resource, int heightMultiple) {
        View viewBottom = LayoutInflater.from(context).inflate(resource, null);
        bottomDialog = new Dialog(context, R.style.dialog_style);
        bottomDialog.setContentView(viewBottom, new ViewGroup.LayoutParams(LinearLayoutCompat.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT / heightMultiple));
        Window window = bottomDialog.getWindow();
        // 为dialog设置动画
        window.setWindowAnimations(R.style.dialog_animation_bottom);
        WindowManager.LayoutParams wl = window.getAttributes();
    ...
    public View showBottomDialog(@LayoutRes int resource, int margin, int padding) {
        View viewMiddlePadding = LayoutInflater.from(context).inflate(resource, null);
